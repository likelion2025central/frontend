...
const RegPart = () => {
  ...
  return (
    <div className="regpart_wrap container">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div className="wrap">
                        ...
                        <div className="btns">
                          <div className="btn" onClick={() => {setSelectedItem(item); setShowDetail(true)}}>희망 제휴 조건 상세보기 →</div>
                        </div>
      ...
      {showDetail && <ManageDetail item = {selectedItem}  onClose = {() => setShowDetail(false)}/>}
